...
Public Class Bluestacks2
    ...
    Public Sub MouseLeftClick(x As Integer, y As Integer) Implements IEmulator.MouseLeftClick
        Dim handle As IntPtr = Me.GetBluestacksWindow(True)
    ...
    Public Function GetBuffer() As Image(Of Bgr, Byte) Implements IEmulator.GetBuffer
        ...
        Dim handle As IntPtr = GetBluestacksWindow(True)
        ...
        Try
            ...
            Dim border As Integer = 0 '(wr.Width - cr.Width) / 2
            Dim caption As Integer = 0 '(wr.Height - cr.Height) - (border * 2)
    ...
    Public Function StopEmulator() As Boolean Implements IEmulator.StopEmulator
        ...
        KillProcessbyName("Bluestacks")
        KillProcessbyName("HD-Plus-Frontend")
        KillProcessbyName("HD-Plus-Service")
    End Function
    ...
    Private Function GetBluestacksWindow(Optional GameWnd As Boolean = False) As IntPtr
